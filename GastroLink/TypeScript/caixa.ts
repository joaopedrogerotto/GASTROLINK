...
function montarModalPagamento(dadosPagamento: DadosPagamento) {

    const pedido: Pedido = dadosPagamento.pedido;
    const formasPagamento: FormaPagamento[] = dadosPagamento.formasPagamento;
    const tituloModal = document.getElementById("tituloPedido")!;
    const conteudo = document.getElementById("conteudoPedido")!;
    ...
    const inputDesconto = document.getElementById("desconto") as HTMLInputElement;
    ...
    const btnGerarPagamento = document.getElementById("btnGerarPagamento") as HTMLButtonElement;
    ...
    btnGerarPagamento.addEventListener("click", () => {
        ...
        function registrarPagamentoNaoPix(pagamento: Pagamento) {
            $.ajax({
